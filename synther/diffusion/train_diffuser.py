...
from synther.online.utils import action_generator
...
if __name__ == '__main__':
    ...
    inputs, obs_dim, action_dim = make_inputs(env)
    ...
    diffusion = construct_diffusion_model(inputs=inputs, agent=None, obs_dim=obs_dim, action_dim=action_dim)
    trainer = Trainer(
        diffusion,
        dataset,
